# V2.7 MASTER FIX BETON - 14/09/2026 - 0 ERREUR
import json, os, datetime, random
from PIL import Image, ImageDraw, ImageFont
from telegram import Update
from telegram.ext import Application, CommandHandler, ContextTypes

VERSION = 'V2.7 MASTER FIX BETON'
...
def generate_image(tickets):
    ...
    try:
        ...
        font_title = font_small = font_tiny = ImageFont.load_default()
    y=30
    draw.text((30,y), f'{VERSION} - SANS CLE', font=font_title, fill=(0,255,120))
    y+=50
    for i,t in enumerate(tickets[:3],1):
        ...
        y+=28; draw.text((30,y), pb, font=font_tiny, fill=(255,200,100))
        y+=22; draw.text((30,y), pr, font=font_tiny, fill=(0,255,200))
        y+=22; draw.text((30,y), marge, font=font_tiny, fill=(150,150,150))
        y+=40
    img.save(IMAGE_FILE)
    return IMAGE_FILE
